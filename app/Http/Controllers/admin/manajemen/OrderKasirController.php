...
class OrderKasirController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.kasir.orders.index', compact('orders', 'menuItems', 'codeOrder'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('orders_kasir.index')->with('success', 'Order created successfully.');
    }
    ...
    public function update(Request $request, Order $order)
    {
        ...
        return redirect()->route('orders_kasir.index')->with('success', 'Order updated successfully.');
    }

    public function destroy(Order $order)
    {
        $order->delete();
        return redirect()->route('orders_kasir.index')->with('success', 'Order deleted successfully.');
    }
    ...
    public function print($id)
    {
        ...
        return view('admin.kasir.orders.print', compact('order'));
    }
}
