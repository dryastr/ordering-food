    ...
    <div class="sidebar-menu">
        <ul class="menu">
            ...
            @if (auth()->user()->role->name == 'admin')
                ...
                <li class="sidebar-item has-sub {{ Request::is('menu_items*') ? 'active' : '' }}">
                    <a href="#" class='sidebar-link'>
                    ...
                    <ul class="submenu">
                        <li class="submenu-item {{ Request::routeIs('menu_items.index') ? 'active' : '' }}">
                            <a href="{{ route('menu_items.index') }}" class="submenu-link">Daftar Menu</a>
                        </li>
                    </ul>
                </li>

                <li class="sidebar-item has-sub {{ Request::is('orders*') ? 'active' : '' }}">
                    <a href="#" class='sidebar-link'>
                    ...
                    <ul class="submenu">
                        <li class="submenu-item {{ Request::routeIs('orders.index') ? 'active' : '' }}">
                            <a href="{{ route('orders.index') }}" class="submenu-link">Daftar Order</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="sidebar-item has-sub {{ Request::is('users*') ? 'active' : '' }}">
                    ...
                    <ul class="submenu">
                        <li class="submenu-item {{ Request::routeIs('users.index') ? 'active' : '' }}">
                            <a href="{{ route('users.index') }}" class="submenu-link">Daftar Karyawan</a>
                        </li>
                    </ul>
                </li>

                <li class="sidebar-item has-sub {{ Request::is('salaries*') ? 'active' : '' }}">
                    <a href="#" class='sidebar-link'>
                    ...
                    <ul class="submenu">
                        <li class="submenu-item {{ Request::routeIs('salaries.index') ? 'active' : '' }}">
                            <a href="{{ route('salaries.index') }}" class="submenu-link">Daftar Penggajian</a>
                        </li>
                    </ul>
                </li>
            @endif

            @if (auth()->user()->role->name == 'koki')
                <li class="sidebar-item has-sub {{ Request::is('list-orders*') ? 'active' : '' }}">
                    <a href="#" class='sidebar-link'>
                        <i class="bi bi-card-checklist"></i>
                        <span>Pesanan</span>
                    </a>
                    ...
                    <ul class="submenu">
                        <li class="submenu-item {{ Request::routeIs('list-orders.index') ? 'active' : '' }}">
                            <a href="{{ route('list-orders.index') }}" class="submenu-link">Daftar Pesanan</a>
                        </li>
                    </ul>
                </li>
            @endif
